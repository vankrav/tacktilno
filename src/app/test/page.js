  ...
  return (
    <div style={{ display: 'flex', height: '100vh' }}>
      <div style={{ width: 250, padding: 10, background: '#f0f0f0' }}>
        ...
        <label>
          Толщина пластины (мм):
          <input type="number" value={plateThickness} onChange={e => setPlateThickness(+e.target.value)} />
        </label>
        <label>
          Высота рельефа (мм):
          <input type="number" value={reliefHeight} onChange={e => setReliefHeight(+e.target.value)} />
        </label>
        <label>
          Heightmap (ч/б):
